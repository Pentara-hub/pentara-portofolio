...
const StyledWrapper = styled.div`
  ...
  .slider:before {
    ...
    box-shadow:
      0 10px 18px rgba(161, 92, 27, 0.59),
  ...
  input:checked + .slider {
    ...
    box-shadow:
      ...
      0 16px 28px rgba(80, 170, 255, 0.12),
      0 3px 6px rgba(53, 154, 179, 0.18);
  }
  ...
  input:checked + .slider:before {
    ...
    box-shadow:
      0 12px 20px rgba(0, 0, 0, 0.92),
      inset -3px -3px 6px rgba(255, 255, 255, 0.06),
      inset 3px 3px 7px rgba(0, 0, 0, 0.65),
      inset -3px -2px 5px -2px #8983f7,  /* your crescent edge */
      inset -10px -4px 0 0 #a3dafb;      /* your crescent fill */
  }
`;
