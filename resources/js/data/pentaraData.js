...
export const PROJECTS = [
  { slug: "Aklemy", title: "Aklemy", category: "Education", mode: "M2 · Engineering Grade", desc: "A full enterprise learning platform — smart quizzes, real-time analytics, and an AI study assistant. Scoped, built, and shipped without missing a milestone.", image: "/images/projects/lms/home.png", icon: "fa-graduation-cap", gradient: "linear-gradient(145deg, #1a4a7a 0%, #0d2847 45%, #163253 100%)" },
  { slug: "fairwheels", title: "FairWheels", category: "Automotive", mode: "M1 · Fast Track", desc: "AI-powered price prediction and vehicle comparison — from rough concept to a live MVP with early users testing the core flow.", image: null, icon: "fa-car", gradient: "linear-gradient(145deg, #3d4f5f 0%, #1e2d3d 50%, #0f1a28 100%)" },
  { slug: "misteral", title: "Misteral", category: "Healthcare", mode: "M2 · Engineering Grade", desc: "A pharmaceutical brand website with product catalog and publishing workflows — designed, built, and launched for real-world traffic.", image: "/images/projects/misteral/home.png", icon: "fa-notes-medical", gradient: "linear-gradient(145deg, #6b3a5c 0%, #3d2248 50%, #1a1530 100%)" },
  { slug: "habittracker", title: "Habit Tracker", category: "Wellness", mode: "M1 · Fast Track", desc: "A wellness app with behavioral analytics, heatmaps, and streak tracking — shipped fast so the founder could validate retention before scaling.", image: "/images/projects/habitTracker/Dashboard.png", icon: "fa-calendar-check", gradient: "linear-gradient(145deg, #4a3d8f 0%, #2a2560 50%, #141835 100%)" },
  { slug: "mymap", title: "MyMap", category: "Fitness", mode: "Y · Discovery", desc: "A fitness app with map-based route tracking — shaped from a sketch into a build-ready product with clear user flows.", image: "/images/projects/MyMap/image.png", icon: "fa-map-marker-alt", gradient: "linear-gradient(145deg, #2d6a8f 0%, #1a4560 50%, #0f2840 100%)" },
];
